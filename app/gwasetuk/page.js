...
3. 마무리 요약 문장 절대 금지. '이러한 과정을 통해', '이를 통해', '이와 같이', '앞으로', '향후' 등으로 시작하는 마무리 문장 대신, 남은 글자수를 활용해 활동 내용과 과정을 더 구체적으로 서술할 것.
4. 개별적 관찰 기록, 반드시 명사형 종결어미(~함, ~임 등) 사용, 특정 표현 금지, ${targetLevel} 수준에 맞는 어휘와 표현 사용.
5. 글자수가 남으면 활동 과정, 학습 태도, 협력 모습, 탐구 깊이 등을 추가로 서술할 것. 절대 요약/정리 문장으로 마무리하지 말 것.
